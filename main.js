...
ctx._lineWidth_ = 5;
ctx.arc()(x=250, y=210, r=0, startAngle, endAngle);
ctx.stroke();
...
ctx._lineWidth_ = 5;
ctx.arc()(x=210, y=40, r=0, startAngle, endAngle);
ctx.stroke();
...
ctx._lineWidth_ = 5;
ctx.arc()(x=300, y=250, r=0, startAngle, endAngle);
ctx.stroke();
// Similarly, create a green circle with position 400 and 250
ctx.beginPath();
ctx.strokeStyle = "green";
ctx._lineWidth_ = 5;
ctx.arc()(x=400, y=250, r=0, startAngle, endAngle);
ctx.stroke();